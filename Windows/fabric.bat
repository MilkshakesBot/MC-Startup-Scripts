...
: Edit the below values to change JVM Arguments, Allocated RAM and Fabric Version for the server
set FABRIC_VERSION="changeme!" &::.jar is not needed here
...
java -jar -Xms"%ALLOCATED_RAM%" -Xmx"%ALLOCATED_RAM%" "%JVM_ARGUMENTS%" "%JVM_ARGUMENTS_RAM%" "%FABRIC_VERSION%".jar nogui