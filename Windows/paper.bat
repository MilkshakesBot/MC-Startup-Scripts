...
IF EXIST ".\paper.jar" (echo "paper.jar already exists skipping download...") ELSE (echo "paper.jar does not exist. Downloading..." &  curl https://papermc.io/api/v2/paper/1.18/latest/download -o paper.jar)
